#Record data class for storing transaction details like sender, receiver, and amount. Then incorporated these changes into a Streamlit interface, enabling users to input these details directly.
